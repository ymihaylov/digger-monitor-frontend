            ...
            <div class="col-md-12">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th scope="col">Claymore Mining Port</th>
                        <th scope="col">Set min total speed</th>
                        <th scope="col">Speed metrics</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" placeholder="Enter IP">
                        </td>
                        <td><a href="#" class="btn btn-primary">Test Ping</a></td>
                        <td>Response in 12 ms</td>
                        <td>
                            <input class="form-control" type="text" placeholder="Enter Port">
                        </td>
                        <td>
                            <input class="form-control" type="number" placeholder="Mining speed">
                        </td>
                        <td>
